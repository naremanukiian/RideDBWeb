...
function buildDCL() {
  ...
  ht(el, `
        ...
        <div class="dcl-card">
          ...
          <div class="dcl-body">
            ...
            <div class="dcl-perms">
              ${r.perms.map(p => `
                <div class="dcl-perm">
                  <span style="font-size:14px;width:20px;flex-shrink:0">${p.icon}</span>
                  <span class="dcl-perm-lbl"><strong>${p.label}</strong></span>
    ...
    <div class="card" style="margin-top:16px">
      <div class="card-hdr"><div class="card-title">Full DCL Script</div><div class="card-meta">Section 8 — ride_sharing_fixed.sql</div></div>
      <div class="card-body">
